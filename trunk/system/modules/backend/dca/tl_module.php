...
(
	...
	'palettes' => array
	(
		'__selector__'                => array('type', 'interactive', 'defineRoot', 'source'),
		'default'                     => 'name,type',
		'navigation'                  => 'name,type,headline;levelOffset,showLevel;navigationTpl,hardLimit,showProtected;defineRoot;align,space,cssID',
		'navigationMain'              => 'name,type,headline;navigationTpl,showProtected;align,space,cssID',
		'navigationSub'               => 'name,type,headline;levelOffset,showLevel;navigationTpl,hardLimit,showProtected;align,space,cssID',
		'customnav'                   => 'name,type,headline;pages;navigationTpl;align,space,cssID',
		'breadcrumb'                  => 'name,type,headline;includeRoot;align,space,cssID',
		'quicknav'                    => 'name,type,headline;customLabel,includeRoot;rootPage;showLevel,hardLimit,showProtected;align,space,cssID',
		'quicklink'                   => 'name,type,headline;customLabel;pages;align,space,cssID',
		'sitemap'                     => 'name,type,headline;includeRoot;rootPage;navigationTpl,showHidden,showProtected;align,space,cssID',
		'login'                       => 'name,type,headline;cols,jumpTo;align,space,cssID',
		'logout'                      => 'name,type,headline;jumpTo;align,space,cssID',
		'personalData'                => 'name,type,headline;editable,newsletters;jumpTo;memberTpl;align,space,cssID',
		'form'                        => 'name,type,headline;form;align,space,cssID',
		'search'                      => 'name,type,headline;searchType,queryType,searchTpl;perPage,totalLength,contextLength;align,space,cssID',
		'html'                        => 'name,type;html',
		'articleList'                 => 'name,type,headline;inColumn,skipFirst;defineRoot;align,space,cssID',
		'flash'                       => 'name,type,headline;size,flashvars,altContent,transparent,searchable;source,singleSRC;interactive;align,space,cssID',
		'flashexternal'               => 'name,type,headline;size,flashvars,altContent,transparent,searchable;source,url;interactive;align,space,cssID',
		'randomImage'                 => 'name,type,headline;multiSRC,imgSize,useCaption;align,space,cssID'
	),
	...
	(
		...
		(
			...
			'search'                  => true,
			'inputType'               => 'text',
			'eval'                    => array('mandatory'=>true, 'rgxp'=>'extnd', 'nospace'=>true, 'unique'=>true)
		),
		'version' => array
		(

...
class RadioTable extends Widget
{
	...
	public function generate()
	{
		...
		$return = '<table cellspacing="0" cellpadding="0" id="ctrl_'.$this->strName.'" class="tl_radio_table'.(strlen($this->strClass) ? ' ' . $this->strClass : '').'" summary="Table holds form input fields">';

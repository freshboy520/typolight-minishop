...
(
	array('Rich Text Editor', 'weitere Informationen über TinyMCE finden Sie auf <a href="http://tinymce.moxiecode.com" title="http://tinymce.moxiecode.com in einem neuen Fenster öffnen" onclick="window.open(this.href); return false;">moxiecode.com</a>.'),
	array('Insert-Tags', 'Insert-Tags sind Platzhalter, die Sie überall in TYPOlight verwenden können. Diese Platzhalter werden dann bei der Ausgabe der Seite durch bestimmte Werte ersetzt.'),

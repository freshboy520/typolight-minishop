...
$GLOBALS['TL_LANG']['tl_content']['mooHeadline'] = array('Akkordeon-Überschrift', 'Bitte geben Sie die Überschrift des Akkordeon Inhaltsfeldes ein (HTML-Tags sind erlaubt).');
$GLOBALS['TL_LANG']['tl_content']['mooStyle']    = array('CSS-Format der Überschrift', 'Hier können Sie die Überschrift mittels CSS formatieren.');
$GLOBALS['TL_LANG']['tl_content']['mooClasses']  = array('Akkordeon Class-Attribute', 'Wenn Sie mehr als eine Akkordeon-Instanz pro Seite betreiben möchten, müssen Sie die Klassennamen der Toggler und Akkordeon-Elemente ändern. Standardmäßig werden die Klassen <em>toggler</em> und <em>accordion</em> benutzt.');
...
$GLOBALS['TL_LANG']['tl_content']['protected']   = array('Element schützen', 'Das Inhaltselement nur für bestimmte Gruppen anzeigen.');
...
$GLOBALS['TL_LANG']['tl_content']['groups']      = array('Erlaubte Mitgliedergruppen', 'Hier können Sie festlegen, welche Mitgliedergruppen das Inhaltselement sehen können.');

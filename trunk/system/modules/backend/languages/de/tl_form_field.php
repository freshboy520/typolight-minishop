...
$GLOBALS['TL_LANG']['FFL']['submit']      = array('Absendefeld', 'Ein Absendefeld enthält die Absendeschaltfläche und die Kopfdaten des Formulars (z.B. Empfänger und Betreff der Email).');
...
$GLOBALS['TL_LANG']['tl_form_field']['email']          = array('Emailadresse', 'prüft ob die Eingabe eine gültige Emailadresse ist.');
...
$GLOBALS['TL_LANG']['tl_form_field']['extensions']     = array('Erlaubte Dateitypen', 'Bitte geben Sie eine durch Kommata getrennte Liste gültiger Dateiendungen ein. Nur solche Datei können auf den Server hochgeladen werden.');
...
$GLOBALS['TL_LANG']['tl_form_field']['storeFile']      = array('Hochgeladene Dateien speichern', 'Wenn Sie diese Option wählen, werden hochgeladene Dateien in einen Ordner auf Ihrem Server verschoben. Wählen Sie diese Option nicht, wenn Sie hochgeladene Dateien per Email versenden und sie nicht speichern möchten.');
$GLOBALS['TL_LANG']['tl_form_field']['uploadFolder']   = array('Upload-Verzeichins', 'Bitte wählen Sie das Verzeichnis, in dem hochgeladene Bilder gespeichert werden sollen.');
...
$GLOBALS['TL_LANG']['tl_form_field']['addSubmit']      = array('Absendeschaltfläche hinzufügen', 'Wenn Sie aber diese Option wählen, wird neben dem aktuellen Feld eine Absendeschaltfläche eingefügt. Benutzen Sie diese Option, um einzeilige Formulare (z.B. ein Suchformular) zu erstellen.');
...
$GLOBALS['TL_LANG']['tl_form_field']['slabel']         = array('Bezeichnung der Absendeschaltfläche', 'Bitte geben Sie eine Bezeichnung für die Absendeschaltfläche ein.');

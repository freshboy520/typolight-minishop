...
$GLOBALS['TL_LANG']['tl_layout']['template']      = array('Layout-Vorlage', 'Bitte wählen Sie eine Layout-Vorlage. Die Standardvorlage heißt <em>fe_page</em>. Wenn Sie eigene Vorlagen hinzufügen möchten, speichern Sie diese im Ordner <em>templates</em> (Dateiendung muss <em>tpl</em> sein).');

...
$GLOBALS['TL_LANG']['tl_faq']['addEnclosure'] = array('Add enclosure', 'Add a downloadable file to the answer.');
$GLOBALS['TL_LANG']['tl_faq']['enclosure']    = array('Enclosure', 'Please choose the file you want to attach to the answer.');

...
$GLOBALS['TL_LANG']['tl_extension']['author']      = array('Autor', 'Bitte geben Sie einen Namen und eine optionale Emailadresse ein (z.B. <em>Name [email@adresse.de]</em>).');
...
$GLOBALS['TL_LANG']['tl_extension']['beClasses']   = array('Backend Klassen', 'Bitte geben Sie eine durch Kommata getrennte Liste zu erstellender Backend Klassendateien ein.');
$GLOBALS['TL_LANG']['tl_extension']['beTables']    = array('Backend Tabellen', 'Bitte geben Sie eine durch Kommata getrennte Liste zu erstellender Backend Tabellen ein.');
$GLOBALS['TL_LANG']['tl_extension']['beTemplates'] = array('Backend Templates', 'Bitte geben Sie eine durch Kommata getrennte Liste zu erstellender Backend Template Dateien ein.');
...
$GLOBALS['TL_LANG']['tl_extension']['feClasses']   = array('Frontend Klassen', 'Bitte geben Sie eine durch Kommata getrennte Liste zu erstellender Frontend Klassendateien ein.');
$GLOBALS['TL_LANG']['tl_extension']['feTables']    = array('Frontend Tabellen', 'Bitte geben Sie eine durch Kommata getrennte Liste zu erstellender Frontend Tabellen ein.');
$GLOBALS['TL_LANG']['tl_extension']['feTemplates'] = array('Frontend Templates', 'Bitte geben Sie eine durch Kommata getrennte Liste zu erstellender Frontend Template Dateien ein.');
...
$GLOBALS['TL_LANG']['tl_extension']['languages']   = array('Sprachen', 'Bitte geben Sie eine durch Kommata getrennte Liste zu erstellender Sprachpakete ein (z.B. <em>en,de</em>).');

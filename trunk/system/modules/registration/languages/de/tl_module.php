...
$GLOBALS['TL_LANG']['tl_module']['reg_activate']   = array('Aktivierungsemail verschicken', 'Wählen Sie diese Option um eine Aktivierungsemail an den registrierten Benutzer zu senden.');
$GLOBALS['TL_LANG']['tl_module']['reg_text']       = array('Aktivierungsemail', 'Bitte geben Sie den Text der Aktivierungsemail ein. Sie können alle Eingabefelder als Platzhalter benutzen (z.B. <em>##lastname##</em>) sowie <em>##domain##</em> (aktuelle Domain) und <em>##link##</em> (Aktivierungslink).');
$GLOBALS['TL_LANG']['tl_module']['reg_password']   = array('Bestätigungsemail', 'Bitte geben Sie den Text der Bestätigungsemail ein. Sie können alle Benutzereigenschaften als Platzhalter benutzen (z.B. <em>##lastname##</em>) sowie <em>##domain##</em> (aktuelle Domain) und <em>##link##</em> (Aktivierungslink).');

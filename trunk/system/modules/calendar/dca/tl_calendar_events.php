...
(
	...
	'palettes' => array
	(
		'__selector__'                => array('addTime', 'recurring'),
		'default'                     => 'title,alias;startDate,endDate;addTime;teaser,details;recurring;published',
	),
...
<div class="limit_height h52 block">
' . $arrRow['details'] . '
</div>' . "\n";
	}

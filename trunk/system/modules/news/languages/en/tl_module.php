...
$GLOBALS['TL_LANG']['tl_module']['news_template']      = array('News layout', 'Please choose a news layout. You can add custom news layouts to folder <em>templates</em>. News template files start with <em>news_</em> and require file extension <em>.tpl</em>.');
...
$GLOBALS['TL_LANG']['tl_module']['news_jumpToCurrent'] = array('Jump to current month', 'If you choose this option, TYPOlight will automatically jump to the news archive of the current month unless a particular news archive has been specified.');

...
$GLOBALS['TL_LANG']['tl_newsletter']['sender']        = array('Absenderadresse', 'Wenn Sie keine Absenderadresse eingeben, wird die Emailadresse des Administrators verwendet.');
$GLOBALS['TL_LANG']['tl_newsletter']['senderName']    = array('Absendername', 'Hier können Sie den Namen des Absenders eingeben.');
$GLOBALS['TL_LANG']['tl_newsletter']['content']       = array('Inhalt', 'Geben Sie den Inhalt des Newsletters ein. Benutzen Sie den Platzhalter <em>##email##</em> um die Empfängeradresse einzufügen. Erstellen Sie Links zum Abbestellen des Newsletters im der Form <em>http://www.domain.de/abbestellen.html?email=##email##</em>.');
$GLOBALS['TL_LANG']['tl_newsletter']['template']      = array('Emailtemplate', 'Bitte wählen Sie ein Emailtemplate (Templategruppe <em>mail_</em>).');
$GLOBALS['TL_LANG']['tl_newsletter']['sendText']      = array('Als Text senden', 'Wenn Sie diese Option wählen, wird der Newsletter als Text versendet. Alle HTML Tags werden dabei entfernt.');

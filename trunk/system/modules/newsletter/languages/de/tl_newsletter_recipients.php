 ...
 * Fields
 */
$GLOBALS['TL_LANG']['tl_newsletter_recipients']['email']  = array('Emailadresse', 'Bitte geben Sie die Emailadresse des Empfängers ein.');
$GLOBALS['TL_LANG']['tl_newsletter_recipients']['active'] = array('Aktiviert', 'Emailadressen werden normalerweise durch Anklicken eines Links in der Bestätigungsemail aktiviert (double-opt-in).');

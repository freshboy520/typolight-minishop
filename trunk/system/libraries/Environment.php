...
class Environment
{
	...
	private function server()
	{
		...
		{
			$this->arrCache['server'] = strlen($_SERVER['REMOTE_ADDR']) ? $_SERVER['REMOTE_ADDR'] : $_SERVER['LOCAL_ADDR'];
		}
	...
	private function request()
	{
		...
		{
			$this->arrCache['request'] = preg_replace('/^' . preg_quote(TL_PATH, '/') . '\/?/i', '', $this->requestUri());
		}

 ...
 */
$GLOBALS['TL_DCA']['tl_module']['palettes']['rss_reader'] = 'name,type,headline;rss_feed,rss_cache,rss_template;rss_numberOfItems,perPage,skipFirst,searchable;align,space,cssID';

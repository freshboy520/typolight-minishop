...
$GLOBALS['TL_LANG']['tl_form']['sendViaEmail'] = array('Per Email versenden', 'Wenn Sie diese Option wählen, werden die Formulardaten per Email versendet.');
$GLOBALS['TL_LANG']['tl_form']['recipient']    = array('Empfänger', 'Bitte geben Sie eine oder mehrere durch Kommata getrennte Empfänger-Emailadressen ein. Eingaben im "Friendly Name Format" (z.B. "Name [name@domain.com]") sind erlaubt.');
$GLOBALS['TL_LANG']['tl_form']['subject']      = array('Betreff', 'Bitte geben Sie eine Betreffzeile für die Email ein. Wenn Sie keine Betreffzeile erfassen, steigt die Wahrscheinlichkeit, dass die Email als SPAM identifiziert wird.');
$GLOBALS['TL_LANG']['tl_form']['format']       = array('Datenformat', 'Bitte wählen Sie ein Format für die Formulardaten.');
...
$GLOBALS['TL_LANG']['tl_form']['email']        = array('Emailformat', 'Dieses Format erwartet die Felder <em>email</em>, <em>subject</em>, <em>message</em> und <em>cc</em> (eine Kopie der Email an den Absender schicken). Anders benannte Felder werden ignoriert. Datei-Uploads sind erlaubt.');
$GLOBALS['TL_LANG']['tl_form']['xml']          = array('XML-Datei', 'Die Formulardaten werden der Email als XML-Datei angefügt.');
$GLOBALS['TL_LANG']['tl_form']['csv']          = array('CSV-Datei', 'Die Formulardaten werden der Email als CSV-Datei (comma separated values) angefügt.');

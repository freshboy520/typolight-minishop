...
$GLOBALS['TL_LANG']['tl_style']['selector']       = array('Selektor', 'Ein Selektor bestimmt, welchem HTML Element oder welcher Elementgruppe eine Formatdefinition zugewiesen wird. Sie können einen oder mehrere durch Kommata getrennte Selektoren erfassen.');
...
$GLOBALS['TL_LANG']['tl_style']['fontfamily']     = array('Schriftarten', 'Bitte geben Sie eine oder mehrere durch Kommata getrennte Schriftarten ein. Verwenden Sie Anführungszeichen falls der Name der Schriftart Leerzeichen enthält und verwenden Sie mindestens eine generische Schriftart.');

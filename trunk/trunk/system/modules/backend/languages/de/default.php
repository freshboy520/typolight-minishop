...
$GLOBALS['TL_LANG']['ERR']['email']          = 'Bitte geben Sie eine gültige Emailadresse ein!';
 ...
 * URLs
 */
$GLOBALS['TL_LANG']['MSC']['url']    = array('Zieladresse', 'Geben Sie die vollständige Zieladresse mit Netzwerkprotokoll ein (z.B. <em>http://www.domain.com</em>). Um einen Emailadresse zu verlinken, geben Sie <em>mailto:name@domain.de</em> ein. Die Verwendung von Insert-Tags (z.B. <em>link_url</em>) ist möglich.');
...
$GLOBALS['TL_LANG']['MSC']['loginBT']        = 'Einloggen';
...
$GLOBALS['TL_LANG']['MSC']['all_info']       = 'Alle aktiven Datensätze der Tabelle %s bearbeiten';

...
$GLOBALS['TL_LANG']['tl_page']['alias']          = array('Seitenalias', 'Der Alias einer Seite ist eine eindeutige Referenz, die anstelle der Seiten ID aufgerufen werden kann. Das ist besonders nützlich, wenn TYPOlight statische URLs verwendet.');
$GLOBALS['TL_LANG']['tl_page']['adminEmail']     = array('Emailadresse des Webseiten-Administrators', 'Die Emailadresse des Webseiten-Administrators wird als Absenderadresse für automatisch generierte Systemnachrichten wie z.B. Aktivierungsemails oder Newsletter Bestätigungsemails verwendet.');
...
$GLOBALS['TL_LANG']['tl_page']['includeChmod']   = array('Zugriffsrechte zuweisen', 'Durch Zugriffsrechte können Sie festlegen, inwiefern ein Backendbenutzer eine Seite und ihre Artikel verändern kann. Wenn Sie diese Option nicht wählen, verwendet die Seite dieselbe Zugriffsrechte wie ihre übergeordnete Seite.');
...
$GLOBALS['TL_LANG']['tl_page']['sitemapName']    = array('Dateiname', 'Bitte geben Sie einen Namen für die XML-Datei ein.');
$GLOBALS['TL_LANG']['tl_page']['sitemapBase']    = array('Basis URL', 'Bitte geben Sie den Basis-URL inklusive Protokoll (z.B. <em>http://</em>) ein.');

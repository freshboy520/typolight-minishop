...
$GLOBALS['TL_LANG']['tl_module']['searchTpl']      = array('Vorlage für Suchergebnisse', 'Bitte wählen Sie eine Vorlage für Suchergebnisse aus. Die Standardvorlage heißt <em>search_default</em>. Wenn Sie eigene Vorlagen hinzufügen möchten, speichern Sie diese im Ordner <em>templates</em> (Dateiendung muss <em>tpl</em> sein).');
$GLOBALS['TL_LANG']['tl_module']['contextLength']  = array('Kontext Spannweite', 'Bitte geben Sie die Anzahl an Buchstaben ein, die auf der linken und rechten Seite jedes Suchbegriffs als Kontext verwendet werden soll.');
...
$GLOBALS['TL_LANG']['tl_module']['useCaption']     = array('Bildname als Bildunterschrift verwenden', 'Wenn Sie diese Option wählen, wird der Name des jeweiligen Bildes unter dem Bild angezeigt.');
...
$GLOBALS['TL_LANG']['tl_module']['searchable']     = array('Durchsuchbar', 'Wenn Sie diese Option wählen, wird das Modul für die Website-Suche indiziert. Es wird empfohlen, diese Option nicht zu wählen, wenn das Modul Teil eines Layouts ist und daher auf zahlreichen Seiten erscheint.');

...
$GLOBALS['TL_LANG']['tl_module']['searchTpl']      = array('Search results template', 'Please choose a search results template. The default template is called <em>search_default</em>. If you want to add your own templates, upload them to the <em>templates</em> directory (file extension has to be <em>tpl</em>).');
$GLOBALS['TL_LANG']['tl_module']['contextLength']  = array('Context range', 'Please enter the number of characters on the left and right side of each keyword that shall be used as context.');
...
$GLOBALS['TL_LANG']['tl_module']['useCaption']     = array('Show image name as caption', 'If you choose this option, the image name will be displayed below the image.');
...
$GLOBALS['TL_LANG']['tl_module']['searchable']     = array('Searchable', 'If you choose this option, the module will be indexed for website searching. It is not recommended to choose this option if the module is part of a layout and therefore appears on numerous pages.');

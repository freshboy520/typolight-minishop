...
$GLOBALS['TL_LANG']['tl_maintenance']['pagesPerCycle'] = array('Pages per cycle', 'To prevent the script from timing out, the rebuild process is split into several cycles. Here you can define the number of pages per cycle depending on the maximum execution time defined in your php.ini.');

...
(
	array('Rich Text Editor', 'for more information about TinyMCE please visit <a href="http://tinymce.moxiecode.com" title="Open http://tinymce.moxiecode.com in a new window" onclick="window.open(this.href); return false;">moxiecode.com</a>.'),
	array('Insert tags', 'insert tags are wildcards that you can insert anywhere in TYPOlight. These tags will be replaced by certain values before a page is printed to the screen.'),

...
$GLOBALS['TL_LANG']['tl_content']['mooHeadline'] = array('Accordion headline', 'Please enter the headline of the accordion content pane (HTML allowed).');
$GLOBALS['TL_LANG']['tl_content']['mooStyle']    = array('Headline CSS format', 'Here you can enter an optional CSS string to format the headline.');
$GLOBALS['TL_LANG']['tl_content']['mooClasses']  = array('Accordion class attributes', 'If you want to run more than one accordion instance per page, you will have to change the class names of your toggler and accordion elements. By default, they use class <em>toggler</em> and <em>accordion</em> (leave blank to use default classes).');

...
configuration file and remove parameter <em>installCount</em>.</p>
...
<p>Please choose a template to be imported. Templates are stored in the global <em>templates</em> directory.</p>

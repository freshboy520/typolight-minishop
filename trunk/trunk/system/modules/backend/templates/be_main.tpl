...
<link rel="stylesheet" type="text/css" href="plugins/tablesort/css/tablesort.css" media="screen" />
...
<span class="header_preview_container"><a href="<?php echo $this->base.$this->frontendFile; ?>" onclick="this.blur(); window.open(this.href); return false;" class="header_preview" title="<?php echo $this->preview; ?>" accesskey="f"><?php echo $this->preview; ?></a> &nbsp; :: &nbsp; </span>

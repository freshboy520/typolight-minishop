...
(
	...
	(
		...
		'default'                     => 'websiteTitle,adminEmail;dateFormat,timeFormat,datimFormat,timeZone;websitePath,characterSet,encryptionKey,customSections,maxImageWidth,resultsPerPage;rewriteURL,disableAlias,extractTplVars,displayErrors,debugMode,disableRefererCheck,useDompdf,enableGZip;editableFiles,validImageTypes,allowedDownload,uploadTypes,allowedTags;useSMTP;useFTP;uploadPath,maxFileSize,imageWidth,imageHeight,jpgQuality,uploadFields;backendTheme,inactiveModules;undoPeriod,versionPeriod,logPeriod,sessionTimeout,lockPeriod;dynamicStopword,minWordLength;defaultUser,defaultGroup,defaultChmod'
	),
	...
	(
		...
		'extractTplVars' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_settings']['extractTplVars'],
			'inputType'               => 'checkbox'
		),
		...
		'dynamicStopword' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_settings']['dynamicStopword'],
			'inputType'               => 'text',
			'eval'                    => array('mandatory'=>true, 'rgxp'=>'digit', 'nospace'=>true)
		),
		'minWordLength' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_settings']['minWordLength'],
			'inputType'               => 'text',
			'eval'                    => array('mandatory'=>true, 'rgxp'=>'digit', 'nospace'=>true)
		),
		'backendTheme' => array

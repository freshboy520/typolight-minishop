...
(
	...
	(
		...
		(
			...
			'search'                  => true,
			'inputType'               => 'text',
			'eval'                    => array('maxlength'=>255, 'rgxp'=>'phone', 'insertTag'=>true, 'feEditable'=>true, 'feGroup'=>'contact')
		),
		'mobile' => array
		(
			...
			'search'                  => true,
			'inputType'               => 'text',
			'eval'                    => array('maxlength'=>255, 'rgxp'=>'phone', 'insertTag'=>true, 'decodeEntities'=>true, 'feEditable'=>true, 'feGroup'=>'contact')
		),
		'fax' => array
		(

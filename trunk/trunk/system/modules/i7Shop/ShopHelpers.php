...
class ShopHelpers {
	 ...
	 * makePrice
	 *
	 * @return string with currency format:String
	 * @author Jonas Schnelli / include7 AG 2008
	 **/
	static function makePrice($currency, $price, $currencyFormat) {
		return str_replace('{$c}', $currency, sprintf($currencyFormat, $price));
	}

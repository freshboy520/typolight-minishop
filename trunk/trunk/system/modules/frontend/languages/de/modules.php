...
$GLOBALS['TL_LANG']['FMD']['quicknav']       = array('Quick-Navigation', 'Dieses Modul erzeugt ein Drop-Down Menü aus allen Seiten mit dem man direkt zu einer bestimmten Seite springen kann.');
$GLOBALS['TL_LANG']['FMD']['quicklink']      = array('Quick-Link', 'Dieses Modul erzeugt ein Drop-Down Menü aus ausgewählten Seiten mit dem man direkt zu einer bestimmten Seite springen kann.');
...
$GLOBALS['TL_LANG']['FMD']['form']           = array('Formular', 'Dieses Modul bindet ein Formular in eine Seite ein. Die Daten eines Formulars können per Email versendet oder von einem anderen Modul (z.B. einem Newslettermodul oder einer passwortgeschützten Seite) weiterverarbeitet werden.');

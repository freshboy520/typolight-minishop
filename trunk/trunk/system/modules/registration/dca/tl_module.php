 ...
 */
$GLOBALS['TL_DCA']['tl_module']['palettes']['registration'] = 'name,type,headline;editable,newsletters;jumpTo;memberTpl,disableCaptcha;reg_groups,reg_allowLogin;reg_assignDir;reg_activate;align,space,cssID';
$GLOBALS['TL_DCA']['tl_module']['palettes']['lostPassword'] = 'name,type,headline;jumpTo;reg_skipName,disableCaptcha;reg_password;reg_jumpTo;align,space,cssID';

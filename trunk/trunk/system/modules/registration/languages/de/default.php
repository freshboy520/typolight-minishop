...
$GLOBALS['TL_LANG']['MSC']['emailAddress']     = 'Emailadresse';
...
$GLOBALS['TL_LANG']['MSC']['adminText']        = 'Ein neuer Benutzer (ID %s) hat sich auf Ihrer Webseite registriert.%sFalls Sie die automatische Email-Aktivierung nicht nutzen, müssen Sie das Konto im Backend manuell aktivieren.';

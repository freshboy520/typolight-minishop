...
(
	...
	(
		...
		'default'                     => 'senderName,sender;subject,content;addFile;template,sendText'
	),
	...
	public function checkPermission()
	{
		...
		switch ($this->Input->get('act'))
		{
			...
			case 'create':
				...
				{
					$this->log('Not enough permissions to create newletters in channel ID "'.$this->Input->get('pid').'"', 'tl_newsletter checkPermission', 5);
...
<div class="limit_height h128 block">
' . $arrRow['content'] . '
</div>' . "\n";
	}

 ...
 */
$GLOBALS['TL_DCA']['tl_module']['palettes']['subscribe']   = 'name,type,headline;nl_channel,nl_template;nl_subscribe;jumpTo;align,space,cssID';
$GLOBALS['TL_DCA']['tl_module']['palettes']['unsubscribe'] = 'name,type,headline;nl_channel,nl_template;nl_unsubscribe;jumpTo;align,space,cssID';


/**
 * Add fields to tl_module
 */
$GLOBALS['TL_DCA']['tl_module']['fields']['nl_channel'] = array
(
	'label'                   => &$GLOBALS['TL_LANG']['tl_module']['nl_channel'],
	'exclude'                 => true,
	'inputType'               => 'radio',

 ...
 * Fields
 */
$GLOBALS['TL_LANG']['tl_newsletter']['subject']       = array('Subject', 'Please enter the subject of the newletter.');
...
$GLOBALS['TL_LANG']['tl_newsletter']['content']       = array('Content', 'Please enter the content of the newsletter. Use the wildcard <em>##email##</em> to insert the recipient\'s e-mail address. Generate unsubscribe links as <em>http://www.domain.com/unsubscribe-page.html?email=##email##</em>.');
$GLOBALS['TL_LANG']['tl_newsletter']['template']      = array('E-mail template', 'Please choose an e-mail template (template group <em>mail_</em>).');
$GLOBALS['TL_LANG']['tl_newsletter']['sendText']      = array('Send as text', 'If you choose this option, the e-mail will be sent as text. All HTML tags will be stripped.');

...
$GLOBALS['TL_LANG']['tl_news']['subheadline']  = array('Subheadline', 'You can enter a subheadline here.');
...
$GLOBALS['TL_LANG']['tl_news']['addEnclosure'] = array('Add enclosure', 'Add a file to the news item.');
$GLOBALS['TL_LANG']['tl_news']['enclosure']    = array('RSS enclosure', 'Please choose the file you want to attach to the RSS feed.');
$GLOBALS['TL_LANG']['tl_news']['source']       = array('Source page', 'Please choose whether the article links to an internal or an external page.');
$GLOBALS['TL_LANG']['tl_news']['jumpTo']       = array('Jump to page', 'Please select the page to which visitors will be redirected. Please note that the target page should include the "newsreader" plugin in order to display the news article.');
...
$GLOBALS['TL_LANG']['tl_news']['internal'] = array('Internal page', 'By clicking the "read more..." button visitors will be redirected to an internal page where they can read the whole article.');
$GLOBALS['TL_LANG']['tl_news']['external'] = array('External website', 'By clicking the "read more..." button visitors will be redirected to an external website where they can read the whole article.');
